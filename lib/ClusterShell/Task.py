...
class Task(object):
    ...
    events in your event handler and check the did_timeout boolean.
    ...
    def run(self, command=None, **kwargs):
        ...
        and check the did_timeout boolean in your Worker event handlers, or
        use num_timeout() or iter_keys_timeout() afterwards.
