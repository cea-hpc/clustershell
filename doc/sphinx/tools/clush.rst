...
administration purposes. etc.). So it may happens that we use
``gateway3-mgmt1`` to reach ``gateway3``.

Since v1.7, the gateways can also use hostnames corresponding to all local
