...
class TaskTimerTest(unittest.TestCase):
    ...
    def testForceDelayedRepeaterAutoClose(self):
        ...
        # one will block thread for INTERVAL+0.1, the second once will block
        # thread for INTERVAL+0.1 more time. Then at next runloop the engine
        # will see our shell command termination and will process both timers
        # one more time before exiting runloop due to lack of engine client.
        self.assertEqual(teh.count, 4)
