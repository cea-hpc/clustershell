...
from ClusterShell import RangeSet as RangeSetModule
...
class RangeSetNDTest(unittest.TestCase):
    ...
    def setUp(self):
        RangeSetModule.BACKEND_TYPE = str
        warnings.simplefilter("always")

    def tearDown(self):
        RangeSetModule.BACKEND_TYPE = RangeSetModule.DEFAULT_BACKEND_TYPE
    ...
    def test_pads(self):
        ...
        with self.assertRaises(TypeError):
            p = rn0.pads() # not supported in str mode
        ...
        with self.assertRaises(TypeError):
            p = rn1.pads() # not supported in str mode
